...
from .views import Organization_Create_API , Organization_List_API , Organization_Update_API , Organization_Delete_API , Organization_Archive_API , Organization_Membership_API , Organization_Membership_Update_API ,Organization_Subscription , Organization_Verify_Subscription
...
urlpatterns = [
    ...
    path('subscription/' , Organization_Subscription.as_view() , name='subscription_add'),
